...
def parse_videos(video_dir, image_dir, parse_rate, transform_fn=None, 
    ...
    for file in tqdm(video_names):  # show a smart progress meter
        ...
        try:
            reader = imageio.get_reader(filename)   # return reader object to read data/metadata of video
        except OSError:
        ...
        # get frame_indexes (time points to split the video)
        # calculate sample size (# of time points) for video using parse_rate
        ...
        for i in tqdm(range(sample_size)):
            ...
            # get image from video at frame_index (split video into images)
            try:
            ...
            if transform_fn is not None:    # currently set to None always
...
if __name__ == '__main__':
    # recieve arguments and provide debugging information
